...
海外VPS：
```
(curl -LfsS https://raw.githubusercontent.com/0xdabiaoge/gost-lite/main/gost.sh -o /usr/local/bin/gt || wget -q https://raw.githubusercontent.com/0xdabiaoge/gost-lite/main/gost.sh -O /usr/local/bin/gt) && chmod +x /usr/local/bin/gt && gt
```
国内VPS：
```
